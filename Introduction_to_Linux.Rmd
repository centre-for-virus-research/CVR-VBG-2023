...
<div class = "red">
```
Check if bash is the default shell on alpha2 (is it zsh?)
```
</div>
...
19. How many proteins does SARS-CoV-2 code for? Use the file SARS-CoV-2.gb to extract protein identifiers ("protein_id").
